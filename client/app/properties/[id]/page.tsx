        ...
        <Container maxWidth="xl" sx={{ py: 2, position: 'relative', zIndex: 1 }}>
          ...
          <Box display={{ md: 'flex' }} gap={4}>
            ...
            <Box flex={2} minWidth={0}>
              ...
              <Dialog open={editOpen} onClose={() => setEditOpen(false)} maxWidth="md" fullWidth>
                ...
                <DialogContent>
                  {/* TODO: مرر بيانات العقار الحالية إلى الفورم عند دعم ذلك */}
                  <PropertyFormForSale />
                </DialogContent>
              </Dialog>
              ...
              <Paper sx={{ 
                ...
                <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 3 }}>
                  <Box sx={{ flex: '1 1 250px', minWidth: 220, p: 2, bgcolor: 'rgba(102, 126, 234, 0.05)', borderRadius: 2, height: '100%' }}>
                    <Typography variant="body2" color="text.secondary">النوع</Typography>
                    <Typography variant="body1" fontWeight="bold" color="#667eea">
                      {property.type}
                        </Typography>
                      </Box>
                  <Box sx={{ flex: '1 1 250px', minWidth: 220, p: 2, bgcolor: 'rgba(118, 75, 162, 0.05)', borderRadius: 2, height: '100%' }}>
                    <Typography variant="body2" color="text.secondary">المساحة</Typography>
                    <Typography variant="body1" fontWeight="bold" color="#764ba2">
                      {property.area} م²
                            </Typography>
                          </Box>
                  <Box sx={{ flex: '1 1 250px', minWidth: 220, p: 2, bgcolor: 'rgba(240, 147, 251, 0.05)', borderRadius: 2, height: '100%' }}>
                  ...
                  <Box sx={{ flex: '1 1 250px', minWidth: 220, p: 2, bgcolor: 'rgba(33, 150, 243, 0.05)', borderRadius: 2, height: '100%' }}>
                  ...
                  <Box sx={{ flex: '1 1 250px', minWidth: 220, p: 2, bgcolor: 'rgba(76, 175, 80, 0.05)', borderRadius: 2, height: '100%' }}>
                  ...
                  <Box sx={{ flex: '1 1 250px', minWidth: 220, p: 2, bgcolor: 'rgba(255, 152, 0, 0.05)', borderRadius: 2, height: '100%' }}>
                ...
                <CardContent sx={{ p: 3 }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 3 }}>
                    <Box sx={{ 
                      ...
                      {property.contactInfo?.agent?.name?.charAt(0) || 'M'}
                    </Box>
                    <Box>
                      <Typography variant="h6" fontWeight="bold" color="#667eea">
                        {property.contactInfo?.agent?.name || 'المطور'}
                  </Typography>
                      <Typography variant="body2" color="text.secondary">
                        {property.contactInfo?.agent?.title || 'مستشار عقاري'}
                      </Typography>
                      <Rating 
                        value={4.5} 
                        precision={0.5} 
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  <Stack spacing={2}>
                    <Button
                      variant="outlined"
                      fullWidth
                      startIcon={<CalendarTodayIcon sx={{ color: '#667eea' }} />}
                      sx={{ 
                        borderRadius: 2,
                        borderColor: '#667eea',
                        color: '#667eea',
                    ...
                    <Button
                      variant="outlined"
                      fullWidth
                      startIcon={<TrendingUpIcon sx={{ color: '#4caf50' }} />}
                      sx={{ 
                        borderRadius: 2,
                        borderColor: '#4caf50',
                        color: '#4caf50',
          ...
          sx={{ 
            ...
            <IconButton 
              ...
              <Card sx={{ mb: 4, borderRadius: 4, bgcolor: '#f0f0f0', border: '1px solid #CCC', boxShadow: '0 8px 32px rgba(102, 126, 234, 0.1)' }}>
                <CardContent sx={{ p: 3 }}>
