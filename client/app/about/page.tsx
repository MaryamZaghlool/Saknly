...
const teamMembers = [
  ...
  },
  {
    ...
    linkedin: "https://www.linkedin.com/in/ahmed-nasser-897b69201/",
    github: "https://github.com/ahmednasser707",
    email: "ahmed@saknly.com",
    description: "Versatile fullstack developer building end-to-end solutions with a focus on performance and reliability.",
    skills: ["React", "Node.js", "MongoDB", "AWS", "Docker","Wireframing","Prototyping"],
    initials: "AN"
  },
  {
    name: "Mahmoud Adel",
    ...
    linkedin: "https://www.linkedin.com/in/mahmoud-zeyad/",
    github: "https://github.com/mahmoudzeyad",
          ...
          <Box sx={{ flex: 1 }}>
            <Fade in timeout={1200}>
              <Paper elevation={0} sx={{ 
                ...
                <Box sx={{ position: "relative", zIndex: 2 }}>
                  <Typography variant="h4" sx={{ color: "#0284c7", fontWeight: 800, mb: 3 }}>
                    رؤيتنا
                  </Typography>
                  <Typography variant="body1" sx={{ fontSize: "1.1rem", lineHeight: 1.8, color: "#374151" }}>
          ...
          <Box sx={{ flex: 1 }}>
            <Fade in timeout={1400}>
              <Paper elevation={0} sx={{ 
                ...
                <Box sx={{ position: "relative", zIndex: 2 }}>
                  <Typography variant="h4" sx={{ color: "#d97706", fontWeight: 800, mb: 3 }}>
                    رسالتنا
                  </Typography>
                  <Typography variant="body1" sx={{ fontSize: "1.1rem", lineHeight: 1.8, color: "#374151" }}>
        ...
        <Box sx={{ mb: 10 }}>
          ...
          <Grid container spacing={4} justifyContent="center">
            <Grid size={{ xs: 12, md: 4 }}>
              <Box sx={{ textAlign: "center", p: 3, background: "white", borderRadius: 4, boxShadow: "0 2px 8px rgba(0,0,0,0.05)", height: "100%" }}>
