  ...
  return (
    <>
      <Box component="form" onSubmit={handleSubmit} sx={{
        background: "#fff", p: { xs: 2, md: 6 }, borderRadius: "24px",
        boxShadow: "0 8px 32px 0 rgba(113, 154, 201, 0.18)", maxWidth: "800px",
        mx: "auto", mt: 5, mb: 5, border: "2px solid #719AC9", gap: 4, display: "flex",
        flexDirection: "column"
      }}>
        <Typography variant="h5" fontWeight="bold" gutterBottom sx={{
          color: "#719AC9", letterSpacing: "1px", textAlign: "center", mb: 2,
        ...
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 2 }}>
          <FormControl fullWidth error={!!errors.operationType}>
            <InputLabel sx={{ color: "#719AC9" }}>نوع العملية</InputLabel>
            <Select
              name="operationType"
              value={formData.operationType}
              onChange={handleSelectChange}
              label="نوع العملية"
              sx={{ color: "#1e293b", '& .MuiSelect-icon': { color: "#719AC9" } }}
            >
          ...
          <FormControl fullWidth error={!!errors.type}>
            <InputLabel sx={{ color: "#719AC9" }}>نوع العقار</InputLabel>
            <Select
              name="type"
              value={formData.type}
              onChange={handleSelectChange}
          ...
          <>
            <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 2, mt: 2 }}>
              <FormControl fullWidth>
                <InputLabel sx={{ color: "#719AC9" }}>نوع الملكية</InputLabel>
                <Select
                  name="ownershipType"
              ...
              <FormControl fullWidth>
                <InputLabel sx={{ color: "#719AC9" }}>حالة العقار</InputLabel>
                <Select
                  name="propertyStatus"
              ...
              <FormControl fullWidth>
                <InputLabel sx={{ color: "#719AC9" }}>طريقة الدفع</InputLabel>
                <Select
                  name="paymentMethod"
            ...
            {formData.paymentMethod !== 'cash' && (
              <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 2, mt: 2 }}>
                ...
                <FormControl fullWidth error={!!errors.installmentPeriodInYears}>
                  <InputLabel sx={{ color: "#719AC9" }}>فترة التقسيط (سنوات)</InputLabel>
                  <Select
              ...
              <TextField 
                ...
                helperText={
                  errors.deliveryTerms ? 
                    <span style={{color: 'red'}}>{errors.deliveryTerms}</span> : 
                    <span style={{color: 'gray'}}>{`${formData.deliveryTerms.length}/300 حرف`}</span>
                }
          ...
          <>
            <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 2, mt: 2 }}>
              ...
              <FormControl fullWidth error={!!errors.leaseDuration}>
                <InputLabel sx={{ color: "#719AC9" }}>عدد أشهر الايجار</InputLabel>
                <Select
                  name="leaseDuration"
            ...
            <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 2, mt: 2 }}>
              <TextField 
                ...
                helperText={
                  errors.rulesOther ? 
                    <span style={{color: 'red'}}>{errors.rulesOther}</span> : 
                    <span style={{color: 'gray'}}>{`${formData.rulesOther.length}/300 حرف`}</span>
                }
                inputProps={{ maxLength: 300 }}
                sx={{
                  '& .MuiFormHelperText-root': {
        ...
        {formData.operationType === 'student' && (
          <>
            <Divider sx={{ my: 2 }} />
            <Typography variant="h6" sx={{ color: "#719AC9" }}>تفاصيل سكن الطلبة</Typography>
            <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 2, mt: 2 }}>
              <FormControl fullWidth error={!!errors.studentRoomType}>
                <InputLabel sx={{ color: "#719AC9" }}>نوع الغرفة</InputLabel>
                <Select
              ...
              <FormControl fullWidth error={!!errors.studentsPerRoom}>
                <InputLabel sx={{ color: "#719AC9" }}>عدد الطلاب في الغرفة</InputLabel>
                <Select
              ...
              <FormControl fullWidth error={!!errors.studentGenderPolicy}>
                <InputLabel sx={{ color: "#719AC9" }}>سياسة النوع</InputLabel>
                <Select
            ...
            <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 2, mt: 2 }}>
              ...
              />
              <FormControl fullWidth>
                <InputLabel sx={{ color: "#719AC9" }}>الفصل الدراسي</InputLabel>
                <Select
                  name="semester"
        ...
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 2 }}>
          <TextField 
            ...
            helperText={
              errors.area ? 
                ...
                <span style={{color: 'gray'}}>{formData.type ? `المساحة المطلوبة: ${getCurrentAreaConstraints().min}-${getCurrentAreaConstraints().max} متر مربع` : ''}</span>
            }
          ...
          <FormControl fullWidth error={!!errors.bedrooms}>
            <InputLabel sx={{ color: "#719AC9" }}>غرف نوم</InputLabel>
            <Select
              name="bedrooms"
          ...
          <FormControl fullWidth error={!!errors.bathrooms}>
            <InputLabel sx={{ color: "#719AC9" }}>حمامات</InputLabel>
            <Select
              name="bathrooms"
        ...
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 2 }}>
          <FormControl fullWidth>
            <InputLabel sx={{ color: "#719AC9" }}>الطابق</InputLabel>
            <Select
              name="floor"
          ...
          <FormControl fullWidth>
            <InputLabel sx={{ color: "#719AC9" }}>إجمالي الطوابق</InputLabel>
            <Select
              name="totalFloors"
        ...
        <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: 2 }}>
          <FormControl fullWidth error={!!errors.location}>
            <InputLabel sx={{ color: "#719AC9" }}>المدينة</InputLabel>
            <Select
              name="location"
          ...
          <TextField 
            ...
            helperText={
              errors.district ? 
                ...
                <span style={{color: 'gray'}}>{`${formData.district.length}/50 حرف`}</span>
            }
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          <Typography variant="subtitle1" sx={{ fontWeight: 'bold', color: '#719AC9' }}>
        ...
        {/* Amenities */}
        <FormControl fullWidth>
          <InputLabel sx={{ color: "#719AC9" }}>المرافق والخدمات</InputLabel>
          <Select
            multiple
            name="amenities"
        ...
        <TextField 
          ...
          helperText={
            errors.title ? 
              ...
              <span style={{color: 'gray'}}>{`${formData.title.length}/70 حرف`}</span>
          }
        ...
        <TextField 
          ...
          helperText={
            errors.description ? 
              ...
              <span style={{color: 'gray'}}>{`${formData.description.length}/400 حرف`}</span>
          }
          ...
          <TextField 
            ...
            helperText={
              errors['contactInfo.name'] ? 
                <span style={{color: 'red'}}>{errors['contactInfo.name']}</span> : 
                <span style={{color: 'gray'}}>{`${formData.contactInfo.name.length}/25 حرف`}</span>
            }
            ...
            sx={{
              '& .MuiFormHelperText-root': {
                color: errors['contactInfo.name'] ? 'error.main' : 'text.secondary',
              }
            }}
          />
          <TextField 
            ...
            helperText={
              errors['contactInfo.phone'] ? 
                <span style={{color: 'red'}}>{errors['contactInfo.phone']}</span> : 
                <span style={{color: 'gray'}}>{`${formData.contactInfo.phone.length}/11 رقم`}</span>
            }
            ...
            sx={{
              '& .MuiFormHelperText-root': {
                color: errors['contactInfo.phone'] ? 'error.main' : 'text.secondary',
              }
            }}
          />
          <TextField
          ...
          <TextField
            ...
            helperText={
              errors['contactInfo.whatsapp'] ? 
                <span style={{color: 'red'}}>{errors['contactInfo.whatsapp']}</span> : 
                <span style={{color: 'gray'}}>{`${formData.contactInfo.whatsapp.length}/11 رقم`}</span>
            }
            inputProps={{ maxLength: 11 }}
            type="tel"
            onKeyDown={(e) => {
        ...
        <Button
          ...
          sx={{
            backgroundColor: "#719AC9",
            '&:hover': { backgroundColor: "#5a7cab" },
            mt: 3
          }}
        >
      ...
      <Dialog open={pendingOpen} onClose={() => setPendingOpen(false)}>
        <DialogTitle>في انتظار الموافقة</DialogTitle>
        <DialogContent>
          سيتم مراجعة إعلانك من قبل الإدارة قبل النشر. شكراً لاستخدامك سكنلي!
        </DialogContent>
        <DialogActions>
          <Button onClick={() => { setPendingOpen(false); router.push('/properties'); }}>
            حسناً
          </Button>
        </DialogActions>
      </Dialog>
